...
**Slug:** `can-you-get-vitamin-d-from-your-palms`
**Primary keyword:** can you get vitamin D from your palms
**Secondary keywords:** vitamin D from hands · how much skin exposed for vitamin D · exposed skin area vitamin D · arms and legs sun vitamin D · vitamin D with minimal sun exposure
**Pillar:** P1 calculation cluster
...
- **ComparisonTable component:** use for the tested exposed-area comparison
- **Callout components:** use for the more-skin-versus-more-time note (info type), Bask download CTA (info type), and medical disclaimer (warning type)
...
'What it means for palms',
]}

>

  <tr>
    <td>Face plus backs of hands, about 5% of body surface</td>
    <td>Raised serum 25(OH)D after controlled UVB exposures</td>
    <td>Small areas can contribute, but this was not a palms-only test</td>
  </tr>
  <tr>
    <td>Upper body</td>
    <td>Produced a larger vitamin D3 rise than face and hands</td>
    <td>More uncovered skin can increase output from the same UVB session</td>
  </tr>
  <tr>
    <td>Whole body</td>
    <td>Produced a larger rise than face and hands; no clear advantage over upper body in this small trial</td>
    <td>The response does not scale neatly enough for a palms-to-IU formula</td>
  </tr>
</ComparisonTable>
...
<Callout type="info" title="More skin can shorten the guesswork">
  Under the same useful UVB conditions, a larger uncovered area can produce more
  vitamin D than palms alone. That does not make prolonged unprotected exposure
...
Stop well before redness. Then use clothing, shade, or sunscreen if you stay outside. Everyday sunscreen use has not been shown to cause vitamin D deficiency in real-world studies, so protecting your skin does not require giving up on vitamin D. See [does sunscreen block vitamin D?](/blog/does-sunscreen-block-vitamin-d) for the lab-versus-real-life difference.
...
<Callout type="info" title="Use the skin you actually have uncovered">
  Bask estimates vitamin D from your local conditions, skin type, session time,
  and exposed area instead of assuming palms equal a standard dose.
...
- See all the variables together: [How much sun do you need for vitamin D?](/blog/how-much-sun-do-you-need-for-vitamin-d)
- Check whether useful UVB is available: [What UV Index do you need for vitamin D?](/blog/what-uv-index-do-you-need-for-vitamin-d)
- Compare exposure times by skin type: [How long to sit in the sun for vitamin D](/blog/how-long-to-sit-in-sun-for-vitamin-d)
- Protect your skin without guessing: [Does sunscreen block vitamin D?](/blog/does-sunscreen-block-vitamin-d)

## Sources

1. [Osmancevic A, et al. "Vitamin D production after UVB exposure: a comparison of exposed skin regions." _Journal of Photochemistry and Photobiology B._ 2015;143:38-43.](https://pubmed.ncbi.nlm.nih.gov/25594723/)
2. [Bogh MK, et al. "Interdependence between body surface area and ultraviolet B dose in vitamin D production: a randomized controlled trial." _British Journal of Dermatology._ 2011;164(1):163-169.](https://pubmed.ncbi.nlm.nih.gov/21039402/)
3. [Jager N, et al. "The Impact of UV-dose, Body Surface Area Exposed and Other Factors on Cutaneous Vitamin D Synthesis." _Anticancer Research._ 2018;38(2):1165-1171.](https://pubmed.ncbi.nlm.nih.gov/29374754/)
...
5. [World Health Organization, "Radiation: The ultraviolet (UV) index"](https://www.who.int/news-room/questions-and-answers/item/radiation-the-ultraviolet-(uv)-index)
6. [US Environmental Protection Agency, "UV Index Scale"](https://www.epa.gov/sunsafety/uv-index-scale-0)

---

<Callout type="warning" title="A note on medical advice">
  This article is educational, not medical advice. If you have a known vitamin D
  deficiency, a history of skin cancer, or take photosensitizing medication,
  talk to a clinician before changing your sun exposure. A blood test is the
  reliable way to know your vitamin D level.
</Callout>

---

_Post file lives at: `content-loops/posts/can-you-get-vitamin-d-from-your-palms.md`_
_When ready to publish, Developer creates `src/content/blog/can-you-get-vitamin-d-from-your-palms.mdx`_
