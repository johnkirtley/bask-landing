...
- [ ] Verify the "base tan ≈ SPF 3 or less" figure and attribution (Skin Cancer Foundation; U.S. Surgeon General's 2014 Call to Action to Prevent Skin Cancer) — confirm exact wording and source URL before publishing
- [ ] Verify AAD 2023 survey stat: "59% of Gen Z adults believe tanning myths, such as... a base tan will prevent sunburn" — confirmed against AAD news release (May 9, 2023, survey of 1,000+ U.S. adults). Re-confirm the URL resolves.
- [ ] Verify SPF 30 filters ~97% and SPF 50 ~98% of UVB (EPA/Skin Cancer Foundation sunscreen transmission figures) — consistent with does-sunscreen-block-vitamin-d post
- [ ] Confirm the 5 blistering sunburns ≈ 80% melanoma risk figure attribution (AAD) and that "blistering" qualifier is kept
- [ ] Check internal links resolve: /blog/best-uv-index-for-tanning, /blog/does-sunscreen-block-vitamin-d, /blog/how-long-to-sit-in-sun-for-vitamin-d, /blog/how-much-sun-do-you-need-for-vitamin-d — all confirmed live in src/content/blog/
...
Here is what actually happens. Those pre-trip sessions each delivered a dose of UV that damaged skin cells. Some of that damage gets repaired; some does not, and the unrepaired portion is what raises long-term cancer risk. Then on the beach, with SPF 3 of "protection," the same person stays out longer than they would have bare-skinned, because they feel less pink early on. The mild redness that would have sent them under the umbrella at 40 minutes doesn't appear until 90 — by which point the cumulative UV dose is higher, not lower, than if they had just worn sunscreen from the start.
...
Commercial tanning beds emit mainly UVA — the wavelength that darkens skin quickly without the fast burn that UVB causes. That is why a bed produces visible color fast. But UVA penetrates deeper into the skin than UVB, and it is the same wavelength class that the World Health Organization's cancer research arm classifies as part of Group 1 carcinogenic UV exposure. First use of a tanning bed before age 30 raises melanoma risk by roughly 75%.

A salon base tan delivers less than SPF 2 of "protection" while adding documented, dose-dependent cancer risk to your lifetime total. It is the worst version of an already bad plan. (The full breakdown of beds and vitamin D is in our [tanning beds post](/blog/best-uv-index-for-tanning) cluster coverage — the short version: beds are bad at vitamin D too, because they short you on the UVB that drives it.)

## What actually protects you

Three things work, and they work better together than any of them does alone:

- **Sunscreen, applied correctly and reapplied.** SPF 30 filters about 97% of UVB; SPF 50 about 98%. The gap between them is small. The gap between either and "no sunscreen" is enormous. Reapply every two hours, and after swimming or heavy sweat. Real-world protection drops fast because people under-apply. If sunscreen and vitamin D is your worry, studies consistently find regular sunscreen use does not cause vitamin D deficiency — the [sunscreen and vitamin D breakdown](/blog/does-sunscreen-block-vitamin-d) covers why.
- **Timing and shade.** UV peaks between roughly 10 a.m. and 4 p.m. Moving your outdoor time earlier or later, and using shade, hats, and clothing, cuts dose without any chemistry. This is also the lever that matters for vitamin D: short, timed sessions when UV is present get you the dose, then you get out. The [sun exposure by skin type guide](/blog/how-long-to-sit-in-sun-for-vitamin-d) has the minute ranges.
- **Honest expectation-setting.** There is no safe way to maintain a cosmetic tan. The Skin Cancer Foundation and the AAD both say it plainly. Short, purposeful sun for vitamin D is a different category from lying out for color.
...
2. [Skin Cancer Foundation, "Tanning"](https://www.skincancer.org/skin-cancer-prevention/tanning/). Characterization of a tan as the skin's response to UV-induced DNA damage; SPF-of-a-tan guidance.
3. [American Academy of Dermatology, "Survey shows Gen Z adults are unfamiliar with sunburn and tanning risks" (May 9, 2023)](https://www.aad.org/news/gen-z-unfamiliar-sunburn-tanning-risks). 59% of Gen Z adults believe tanning myths including that a base tan prevents sunburn; survey of 1,000+ U.S. adults.
4. [US EPA, "Sunscreen: How to Help Protect Your Skin from the Sun"](https://www.epa.gov/sunsafety/how-help-protect-yourself-sun). SPF 30 filters ~97% of UVB; SPF 50 ~98%; real-world application rates lower protection.
...
6. [IARC/WHO, classification of UV-emitting tanning devices as Group 1 carcinogens (2009)](https://www.iarc.who.int/news-events/sunbeds-and-uv-radiation/). UVA dominance in commercial beds; melanoma risk increase with first use before age 30.
