...
- [ ] Verify the melanopsin / ipRGC → suprachiasmatic nucleus (master clock) pathway and the "clock drifts slightly longer than 24 hours, reset by morning light" framing against NIGMS Circadian Rhythms fact sheet
- [ ] Verify Wright et al. 2013 camping study finding (natural light entrained the circadian clock; melatonin aligned to sunrise/sunset) against _Current Biology_ 2013;23(16):1554–1558
- [ ] Verify illuminance figures: direct sun ~32,000–100,000 lux; overcast day ~1,000–10,000 lux; typical indoor ~100–500 lux — confirm ranges are framed as approximations
- [ ] Verify glass blocks UVB (no vitamin D) but transmits visible light (circadian signal survives) against published `can-you-get-vitamin-d-through-a-window` and the morning-UV-below-3 claim against `what-uv-index-do-you-need-for-vitamin-d`
- [ ] Verify 10,000-lux light therapy standard (~20–30 min, morning) for seasonal affective disorder against a clinical source; do not overstate morning sun as a depression treatment (mental-health YMYL)
- [ ] Confirm "Author: Bask Health Team" per E-E-A-T
- [ ] Check App Store link points to canonical URL `id6758405235` (no stale `id6741454317`)
- [ ] Verify internal links resolve: /blog/best-time-of-day-to-get-vitamin-d, /blog/how-much-sun-do-you-need-for-vitamin-d, /blog/what-uv-index-do-you-need-for-vitamin-d, /blog/can-you-get-vitamin-d-through-a-window (all live in `src/content/blog/`)
- [ ] Future internal-link targets once published: `can-you-get-vitamin-d-in-the-morning` (P1.11) and the SAD / winter-depression post (P3.3) — add these links later, do not link them now (not yet live)

---

## Post content

Morning sunlight does something different from midday sun. Instead of making vitamin D, it sets your body's internal clock. Getting bright daylight into your eyes within the first hour or two after waking helps lock your sleep cycle in place, sharpens daytime alertness, and supports mood. Those benefits come from visible light reaching your eyes, not from UVB on your skin, which is why early sun is excellent for your rhythm even though it makes almost no vitamin D.
...
But morning light still does something important. Bright daylight entering your eyes is the strongest signal your body uses to set its 24-hour clock. This has nothing to do with your skin or with UV rays. It is a vision signal: how much light is reaching your retina, and when.
...
That reset signal is light. Specialized cells in your retina, intrinsically photosensitive retinal ganglion cells, use a light-sensitive protein called melanopsin that is tuned to the blue wavelengths that dominate daylight. When morning light reaches these cells, they send a direct signal to the master clock. The clock uses the timing of that signal to anchor the day: melatonin gets suppressed, you feel alert, and a timer starts that helps melatonin rise again roughly 14 to 16 hours later, which is what makes you sleepy at a reasonable hour.
...
Anchoring your clock with morning light shows up in three places most people can feel.
...
This is the distinction the whole post hinges on, and it is the one online discussion keeps getting tangled. The two kinds of "sun" run on different wavelengths, hit different parts of the body, and fail or succeed under different conditions.
...
The practical takeaway: you can get your circadian benefit through a window or on a cloudy day, because glass and clouds do not block visible light. You cannot get vitamin D through a window at all, because glass filters out the UVB, and clouds cut it substantially. ([Here is the full breakdown of why windows block vitamin D.](/blog/can-you-get-vitamin-d-through-a-window))

This also settles the question of whether you should "stare at the sun." You should not. You need bright light to reach your eyes, which happens naturally when you are outdoors in daylight and looking at the world around you: the sky, the landscape, your morning walk. Looking straight at the sun is not necessary and it damages your eyes.
...
- **Let light reach your eyes, and skip the sunglasses.** You should not stare at the sun. Contacts and regular prescription glasses are fine; sunglasses block the signal and defeat the purpose.
...
- **A window helps, but weakly.** Visible light passes through glass, so sitting near a window delivers some circadian signal. But intensity drops fast as you move away from the glass. It is a fallback, not a replacement for being outside.
...
Roughly 5 to 10 minutes on a clear day and 15 to 20 minutes when it is overcast, within the first hour or two of waking. The brighter the light, the less time you need. Being outdoors is the key, because outdoor daylight is tens of times brighter than indoor light. On dim winter mornings, a 10,000-lux light box for 20 to 30 minutes is the standard substitute.
...
No, and you should not. You need bright outdoor light to reach your eyes, which happens naturally when you are outside looking at your surroundings. Sunglasses block the signal, so leave them off for those few minutes. Regular prescription glasses and contacts are fine.
...
4. Terman M, Terman JS. "Light therapy for seasonal and nonseasonal depression: efficacy, protocol, safety, and side effects." _CNS Spectrums._ 2005;10(8):623–634. The 10,000-lux, ~30-minute morning protocol for bright light therapy.
