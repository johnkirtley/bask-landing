...
_Pulled 2026-06-22. All RevenueCat data is app-wide; no blog-to-install attribution is possible at this layer._
...
_May revenue reads near zero in the monthly chart but the 28-day overview includes it in the $314 total — this is likely a measurement-period overlap artifact. Revenue is definitively accelerating; the exact May attribution is unclear._
...
| `best-uv-index-for-tanning`               | _not live_ | —         | —          | —         | —            | —               | —       | **READY TO PUBLISH — not yet in `/src/content/blog/`. Publish ASAP; summer demand is live now.** |
...
_All GSC/CTA columns will populate once integration is wired. Re-run this snapshot after GSC is connected._
