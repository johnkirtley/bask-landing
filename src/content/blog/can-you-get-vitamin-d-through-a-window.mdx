...
<ComparisonTable headers={['Glass', 'UVB (vitamin D)', 'UVA (aging/tanning)']}>
  <tr>
...
<Callout type="info" title="Know when to actually step outside">
  Bask tracks your live outdoor UV so you know the minutes real vitamin D
  production is happening on your skin, not behind glass.
